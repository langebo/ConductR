...
public class FirstQueryLoggingInterceptor : QueryInterceptor
{
    private readonly ILogger logger;

    public FirstQueryLoggingInterceptor(IQueryDispatcher dispatcher, ILogger<FirstQueryLoggingInterceptor> logger) : base(dispatcher)
    {
        this.logger = logger;
    }
